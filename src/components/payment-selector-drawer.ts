        ...
        <div class="flex flex-col gap-0">
          ...
          >
            <div class="flex items-center gap-3">
              <div
                class="size-[42px] rounded-[10px] bg-[#E62129] flex flex-col items-center justify-center text-white font-bold leading-none italic shadow-sm"
          ...
          <div class="flex items-center justify-between py-4 border-b border-stroke cursor-not-allowed opacity-75">
            <div class="flex items-center gap-3">
              <div
                class="size-[42px] rounded-[10px] bg-[#00AED6] flex items-center justify-center text-white shadow-sm"
              >
            ...
            <input
              ...
              name="paymentMethod"
              value="gopay"
              class="appearance-none size-5 rounded-full border-[5px] border-disabled bg-stroke cursor-not-allowed"
              disabled
            />
          </div>
          ...
          >
            <div class="flex items-center gap-3">
              <div
                class="size-[42px] rounded-[10px] bg-[#118EEA] flex items-center justify-center text-white font-bold italic text-sm shadow-sm"
                style="font-family: Arial, sans-serif;"
              >
